...
var ProjectsComponent = (function () {
    function ProjectsComponent(ngZone, router, route, answerService) {
        var _this = this;
        this.ngZone = ngZone;
        this.router = router;
        this.route = route;
    ...
    ProjectsComponent.prototype.createProject = function () {
        this.answerService.answer = new __WEBPACK_IMPORTED_MODULE_2__models_index__["a" /* Answer */]('', '', 1, [], []);
        this.router.navigate(['./question'], { relativeTo: this.route });
    };
    ProjectsComponent.prototype.start = function () {
        this.newProject = false;
    };
...
var QuestionComponent = (function () {
    function QuestionComponent(ngZone, questionService, answerService, router, route) {
        var _this = this;
        this.ngZone = ngZone;
    ...
    QuestionComponent.prototype.anterior = function () {
        ...
        var long = this.answerService.answer.questions.length;
    ...
    QuestionComponent.prototype.isJumping = function () {
        this.jump = 0;
    ...
    QuestionComponent.prototype.toggleSelect = function (i) {
        var selected = this.currentQuestion.options[i].selected;
        if (selected)
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('containerQuestion'),
...
QuestionComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgZone"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgZone"]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__services_index__["d" /* QuestionService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_index__["d" /* QuestionService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2__services_index__["e" /* AnswerService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_index__["e" /* AnswerService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* Router */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* ActivatedRoute */]) === "function" && _f || Object])
], QuestionComponent);
...
UserModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_9__services_index__["e" /* AnswerService */]
        ]
    })
], UserModule);
