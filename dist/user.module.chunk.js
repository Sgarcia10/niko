    ...
    ProjectsComponent.prototype.add = function () {
        ...
        this.projectService.getActiveSurvey()
            ...
            if (survey) {
                ...
                _this.currentProject = new __WEBPACK_IMPORTED_MODULE_2__models_index__["g" /* Project */]('', survey._id, 1, '', '', '', 'individual', '', new __WEBPACK_IMPORTED_MODULE_2__models_index__["f" /* Period */](2018, 1), '', _this.currentUser);
                window.scrollTo(0, 0);
            }
            else {
