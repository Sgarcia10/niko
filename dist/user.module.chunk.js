...
var ProjectsComponent = (function () {
    ...
    ProjectsComponent.prototype.ngOnInit = function () {
        ...
        this.currentUser = new __WEBPACK_IMPORTED_MODULE_2__models_index__["k" /* UserProject */](u._id, u.username, u.code);
        this.projectService.currentProject = null;
        this.setPeriods();
        this.getProjects();
    };
    ProjectsComponent.prototype.setPeriods = function () {
        this.periods = [
            '201110',
            '201120',
            '201130',
    ...
    ProjectsComponent.prototype.saveProject = function () {
        ...
        this.projectService.create(this.currentProject).subscribe(function (data) {
            ...
            _this.answerService.setQuestionAnswered(new __WEBPACK_IMPORTED_MODULE_2__models_index__["h" /* QuestionAnswered */]('', 1, '', idSurvey, data._id, 0, '', '', [], []));
    ...
    ProjectsComponent.prototype.add = function () {
        ...
        this.projectService.getActiveSurvey()
            ...
            if (survey) {
                ...
                _this.currentProject = new __WEBPACK_IMPORTED_MODULE_2__models_index__["f" /* Project */]('', survey._id, '', '', '', '', 'individual', '', '', '', _this.currentUser);
                window.scrollTo(0, 0);
            }
            else {
    ...
    ProjectsComponent.prototype.continue = function (i) {
        ...
        if (p.currentAnswerId && p.currentAnswerId !== '-1') {
            ...
            this.answerService.setQuestionAnswered(new __WEBPACK_IMPORTED_MODULE_2__models_index__["h" /* QuestionAnswered */]('', -1, '', idSurvey, p._id, 0, '', '', [], []));
    ...
    ProjectsComponent.prototype.getColor = function (i) {
        var project = this.projects[i];
        if (project.currentAnswerId === '-1')
            return 'rgba(100, 196, 16, 0.66)';
        else
            return 'rgba(198, 149, 154, 0.5)';
    };
...
// module
exports.push([module.i, "\n\n.container-cover {\n\tbackground: url(" + __webpack_require__("../../../../../src/assets/bg-pattern.png") + "),#466bb4;\n\tbackground: url(" + __webpack_require__("../../../../../src/assets/bg-pattern.png") + "),linear-gradient(to left,#1d479a,#5175e3);\n}\n\n.container-cover-message {\n\tbackground: url(" + __webpack_require__("../../../../../src/assets/bg-pattern.png") + "),#466bb4;\n\tbackground: url(" + __webpack_require__("../../../../../src/assets/bg-pattern.png") + "),linear-gradient(to left,#f09d0e,#e65c29);\n}\n\n.container-cover-result {\n\tbackground: url(" + __webpack_require__("../../../../../src/assets/bg-pattern.png") + "),#e03a5b;\n\tbackground: url(" + __webpack_require__("../../../../../src/assets/bg-pattern.png") + "),linear-gradient(to left,#e03a5b,#fa5050);\n}\n\n.container-full{\n  width: 100%;\n\tmin-height: 100%;\n}\n\n.card-question{\n\tbackground-color: transparent;\n\tborder: none;\n\tmargin-top: 10px;\n\tmargin-bottom: 10px;\n}\n\n.header-question{\n\tbackground-color: rgba(238, 238, 238, 0.64);\n\tcolor: rgb(20, 85, 138);\n  font-size: 17px;\n  line-height: 1.2;\n  font-weight: bold;\n  word-spacing: 1px;\n  font-family: 'Catamaran',sans-serif;\n}\n\n.block-question{\n  text-justify: inter-word;\n  text-align: left;\n\tpadding: 10px;\n}\n\n.question-title{\n  font-size: 20px;\n  line-height: 1.2;\n  font-weight: bold;\n  word-spacing: 1px;\n  font-family: 'Catamaran',sans-serif;\n}\n\n.move-group{\n\tpadding: 15px;\n}\n\n.respuesta-abierta{\n  min-width: 100%;\n}\n\n.respuesta-unica{\n  min-width: 100%;\n  text-align: left;\n}\n\n.text-area{\n\tmin-width: 100%;\n}\n\n.col-move{\n\ttext-align: center;\n}\n\n.move-btn{\n\twidth: 60px;\n\theight: 60px;\n\ttext-align: center;\n\tborder-radius: 1px;\n\tborder-style: solid;\n\tborder-radius: 25px;\n\tborder-color: white;\n\tcolor: white;\n  font-size: 12px;\n  line-height: 1.428571429;\n}\n\n.message{\n\tposition: inherit;\n  margin-top: 50%;\n  -webkit-transform: translateY(-50%);\n          transform: translateY(-50%);\n}\n\n.message-title{\n  font-size: 20px;\n  line-height: 1.2;\n  font-weight: bolder;\n  word-spacing: 1px;\n  font-family: 'Catamaran',sans-serif;\n}\n\n.message-text{\n  font-size: 17px;\n  text-align: justify;\n  text-justify: inter-word;\n  line-height: 1.4;\n  font-weight: bold;\n  font-family: 'Catamaran',sans-serif;\n}\n\n.result-title{\n\tbackground-color: rgba(238, 238, 238, 0.64);\n\tcolor: rgb(20, 85, 138);\n  font-size: 22px;\n  line-height: 1.2;\n  font-weight: bolder;\n  word-spacing: 1px;\n  font-family: 'Catamaran',sans-serif;\n}\n\n.card-remark{\n\tbackground-color: transparent;\n\tborder-color: white;\n\tmargin-top: 10px;\n\tmargin-bottom: 10px;\n}\n\n.header-remark{\n\tbackground-color: rgba(238, 238, 238, 0.64);\n\tcolor: rgb(20, 85, 138);\n  font-weight: bold;\n  font-size: 17px;\n}\n\n.block-remark{\n  text-align: justify;\n  text-justify: auto;\n\twhite-space: pre-line;\n}\n\n\n.btn-result {\n\tcolor: white;\n\tmargin-top: 10px;\n\tborder: 1px solid;\n\tborder-radius: 300px;\n\tborder-color: white;\n\tpadding: 15px 45px;\n\tfont-size: 14px;\n  transition: all 0.3s;\n\tfont-weight: bold;\n\tmargin-bottom: 10px;\n}\n\n.btn-result:hover {\n  transition: all 0.3s;\n  background-color: rgba(252, 251, 249, 0.54);\n\tcolor: rgb(20, 85, 138);\n  font-weight: bolder;\n}\n\n@media screen and (min-width : 992px){\n}\n@media screen and (max-width : 992px){\n}\n@media screen and (max-width : 768px){\n}\n@media screen and (max-width : 576px){\n\t.question-title{\n\t\tfont-size: 16px;\n\t}\n\t.header-question{\n\t\tfont-size: 16px;\n\t}\n\t.message-title{\n\t\tfont-size: 16px;\n\t}\n\t.message-text{\n\t\tfont-size: 13px;\n\t}\n}\n", ""]);
...
var QuestionComponent = (function () {
    ...
    QuestionComponent.prototype.getMargin = function () {
        var _this = this;
        setTimeout(function () {
            var size = window.innerHeight / 2 - 90;
        ...
        this.questionService.getByPos(currentPos, this.currentQuestionAnswered.idSurvey)
            ...
            if (!(data === '')) {
                ...
                if (_this.currentQuestionAnswered.optionsAnswered.length === 0) {
                    ...
                    _this.optionsAnswered = _this.currentQuestionAnswered.optionsAnswered;
                }
                _this.isShowQuestion = true;
                _this.getMargin();
            }
            else {
                _this.finishProject();
    ...
    QuestionComponent.prototype.next = function () {
        ...
        this.answerService.create().subscribe(function (data) {
            _this.currentQuestionAnswered = new __WEBPACK_IMPORTED_MODULE_2__models_index__["h" /* QuestionAnswered */]('', nextPos, '', idSurvey, idProject, currentPos, '', '', [], []);
    ...
    QuestionComponent.prototype.jump = function () {
        var i = 0;
        var n = 0;
        if (this.currentQuestionAnswered.type !== __WEBPACK_IMPORTED_MODULE_4__data_questionTypes__["a" /* types */][3].type && this.currentQuestionAnswered.type !== __WEBPACK_IMPORTED_MODULE_4__data_questionTypes__["a" /* types */][2].type) {
    ...
    QuestionComponent.prototype.back = function () {
        var _this = this;
        this.isShowQuestion = false;
        var id = this.currentQuestionAnswered._id;
        var prevPos = this.currentQuestionAnswered.prevPos;
        var idProject = this.currentQuestionAnswered.idProject;
        if (id !== '') {
            this.answerService.remove(id).subscribe(function (data) {
                _this.loadAnswerByPos(prevPos, idProject);
            }, function (err) {
                _this.alertService.error(err);
            });
        }
    ...
    QuestionComponent.prototype.loadAnswerByPos = function (pos, idProject) {
        var _this = this;
        this.answerService.getByPos(pos, idProject).subscribe(function (answer) {
            _this.currentQuestionAnswered = answer;
            _this.loadCurrentQuestion();
        }, function (err) {
            _this.alertService.error(err);
        });
    };
    QuestionComponent.prototype.finishProject = function () {
        var _this = this;
        var idProject = this.currentQuestionAnswered.idProject;
        this.answerService.finishProject(idProject).subscribe(function (data) {
    ...
    QuestionComponent.prototype.getResult = function () {
        ...
        this.answerService.getResult(idProject).subscribe(function (data) {
            var finalMessage = new __WEBPACK_IMPORTED_MODULE_2__models_index__["c" /* Message */]('Esperamos que Niko le haya ayudado.', '', null);
            _this.remarks = data;
    ...
    QuestionComponent.prototype.toggleSelect = function (i) {
        if (this.currentQuestion.type === 'unica') {
            for (var j = 0; j < this.optionsAnswered.length; j++) {
    ...
    QuestionComponent.prototype.validAbierta = function () {
    ...
    QuestionComponent.prototype.validNoAbierta = function () {
        if (this.currentQuestion.type !== 'abierta') {
            var valid = false;
            for (var j = 0; j < this.optionsAnswered.length; j++) {
    ...
    QuestionComponent.prototype.showMessage = function (i) {
    ...
    QuestionComponent.prototype.getCoverClass = function () {
        if (this.isShowResult)
            return { 'container-cover-result': true };
        if (this.isShowMessage)
            return { 'container-cover-message': true };
